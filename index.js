...
*/
const A187 = '👾K187👾'; // JANGAN UBAH-UBAH INFO!!!
const instagram = 'https://instagram.com/ff.kelvin15'; // JANGAN UBAH-UBAH INFO!!!
const nomer = 'Wa.me/+6285212830930'; // JANGAN UBAH-UBAH INFO!!!
...
conn.sendMessage(id, ' _Iyah aku disini kak...ada yang bisa saya bantu? Ketik *#help* untuk melihat fitur bot kami🙏_ ' ,MessageType.text);
}
else if (text == 'P'){
conn.sendMessage(id, ' _Iyah aku disini kak...ada yang bisa saya bantu? Ketik *#help* untuk melihat fitur bot kami🙏_ ' ,MessageType.text);
}
...
conn.sendMessage(id, ' *Owner AR15BOT wa.me/+6285212830930* ' ,MessageType.text);
}
else if (text == '#help'){
...
conn.sendMessage(id, ' *Creator K187Id wa.me/+6285212830930* ' ,MessageType.text);
}
else if (text == 'Pagi'){
